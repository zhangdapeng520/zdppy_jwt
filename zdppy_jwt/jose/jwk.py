from zdppy_jwt.jose.backends.base import Key
from zdppy_jwt.jose.constants import ALGORITHMS
from zdppy_jwt.jose.exceptions import JWKError

try:
    from zdppy_jwt.jose.backends import RSAKey  # noqa: F401
except ImportError:
    pass

try:
    from zdppy_jwt.jose.backends import ECKey  # noqa: F401
except ImportError:
    pass

try:
    from zdppy_jwt.jose.backends import AESKey  # noqa: F401
except ImportError:
    pass

try:
    from zdppy_jwt.jose.backends import DIRKey  # noqa: F401
except ImportError:
    pass

try:
    from zdppy_jwt.jose.backends import HMACKey  # noqa: F401
except ImportError:
    pass
...
def get_key(algorithm):
    if algorithm in ALGORITHMS.KEYS:
        ...
        from zdppy_jwt.jose.backends import RSAKey  # noqa: F811

        return RSAKey
    elif algorithm in ALGORITHMS.EC:
        from zdppy_jwt.jose.backends import ECKey  # noqa: F811

        return ECKey
    elif algorithm in ALGORITHMS.AES:
        from zdppy_jwt.jose.backends import AESKey  # noqa: F811

        return AESKey
    elif algorithm == ALGORITHMS.DIR:
        from zdppy_jwt.jose.backends import DIRKey  # noqa: F811
