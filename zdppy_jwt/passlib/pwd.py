...
from zdppy_jwt.passlib.utils.compat import PY2, irange, itervalues, int_types
from zdppy_jwt.passlib.utils import rng, getrandstr, to_unicode
...
def genword(entropy=None, length=None, returns=None, **kwds):
    ...
    Usage Example::
        ...
        >>> from zdppy_jwt.passlib import pwd
        >>> pwd.genword()
        'DnBHvDjMK6'
