...
# site
# pkg
from zdppy_jwt.passlib.exc import ExpectedTypeError
from zdppy_jwt.passlib.utils.decor import deprecated_function
from zdppy_jwt.passlib.utils.compat import native_string_types
from zdppy_jwt.passlib.crypto.digest import norm_hash_name, lookup_hash, pbkdf1 as _pbkdf1, pbkdf2_hmac, compile_hmac
# local
__all__ = [
    # hash utils
    "norm_hash_name",
...
def get_prf(name):
    ...
    Usage example::
        ...
        >>> from zdppy_jwt.passlib.utils.pbkdf2 import get_prf
