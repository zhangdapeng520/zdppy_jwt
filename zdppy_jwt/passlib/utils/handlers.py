...
# site
# pkg
from zdppy_jwt.passlib import exc as exc, ifc as ifc
from zdppy_jwt.passlib.exc import MissingBackendError, PasslibConfigWarning, \
                        PasslibHashWarning
from zdppy_jwt.passlib.ifc import PasswordHash
from zdppy_jwt.passlib.registry import get_crypt_handler
...
from zdppy_jwt.passlib.utils.binary import (
    BASE64_CHARS, HASH64_CHARS, PADDED_BASE64_CHARS,
    HEX_CHARS, UPPER_HEX_CHARS, LOWER_HEX_CHARS,
    ALL_BYTE_VALUES,
)
from zdppy_jwt.passlib.utils.compat import join_byte_values, irange, u, native_string_types, \
                                 uascii_to_str, join_unicode, unicode, str_to_uascii, \
                                 join_unicode, unicode_or_bytes_types, PY2, int_types
from zdppy_jwt.passlib.utils.decor import classproperty, deprecated_method
# local
__all__ = [
...
def mask_value(value, show=4, pct=0.125, char=u"*"):
    ...
    if not isinstance(value, unicode):
        if isinstance(value, bytes):
            from zdppy_jwt.passlib.utils.binary import ab64_encode
