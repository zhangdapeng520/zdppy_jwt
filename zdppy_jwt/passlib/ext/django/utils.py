...
try:
    ...
    DJANGO_VERSION = ()
# pkg
from zdppy_jwt.passlib import exc, registry
from zdppy_jwt.passlib.context import CryptContext
from zdppy_jwt.passlib.exc import PasslibRuntimeWarning
from zdppy_jwt.passlib.utils.compat import get_method_function, iteritems, OrderedDict, unicode
from zdppy_jwt.passlib.utils.decor import memoized_property
# local
__all__ = [
    "DJANGO_VERSION",
    "MIN_DJANGO_VERSION",
...
##from zdppy_jwt.passlib.registry import register_crypt_handler
##from zdppy_jwt.passlib.utils import classproperty, to_native_str, to_unicode
##from zdppy_jwt.passlib.utils.compat import unicode
##
##
