...
# site
# pkg
from zdppy_jwt.passlib.handlers.bcrypt import _wrapped_bcrypt
from zdppy_jwt.passlib.hash import argon2, bcrypt, pbkdf2_sha1, pbkdf2_sha256
from zdppy_jwt.passlib.utils import to_unicode, rng, getrandstr
from zdppy_jwt.passlib.utils.binary import BASE64_CHARS
from zdppy_jwt.passlib.utils.compat import str_to_uascii, uascii_to_str, unicode, u
...
def _import_des_crypt():
    ...
    if des_crypt is None:
        from zdppy_jwt.passlib.hash import des_crypt
    return des_crypt
