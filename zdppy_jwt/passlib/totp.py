...
from zdppy_jwt.passlib.utils.compat import PY3
# core
import base64
import calendar
import json
...
from zdppy_jwt.passlib.exc import TokenError, MalformedTokenError, InvalidTokenError, UsedTokenError
from zdppy_jwt.passlib.utils import (to_unicode, to_bytes, consteq,
                           getrandbytes, rng, SequenceMixin, xor_bytes, getrandstr)
from zdppy_jwt.passlib.utils.binary import BASE64_CHARS, b32encode, b32decode
from zdppy_jwt.passlib.utils.compat import (u, unicode, native_string_types, bascii_to_str, int_types, num_types,
                                  irange, byte_elem_value, UnicodeIO, suppress_cause)
from zdppy_jwt.passlib.utils.decor import hybrid_method, memoized_property
from zdppy_jwt.passlib.crypto.digest import lookup_hash, compile_hmac, pbkdf2_hmac
from zdppy_jwt.passlib.hash import pbkdf2_sha256
# local
__all__ = [
    # frontend classes
    "AppWallet",
...
class TOTP(object):
    ...
    def using(cls, digits=None, alg=None, period=None,
        ...
        As an example::
            ...
            >>> from zdppy_jwt.passlib.totp import TOTP, generate_secret
...
#            counter += 1
    ...
    def to_uri(self, label=None, issuer=None):
        ...
        Usage example::
            ...
            >>> from zdppy_jwt.passlib.totp import TOTP
