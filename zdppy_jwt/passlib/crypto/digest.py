...
from zdppy_jwt.passlib.utils import join_bytes, to_native_str, join_byte_values, to_bytes, \
                          SequenceMixin, as_bool
from zdppy_jwt.passlib.utils.compat import irange, int_types, unicode_or_bytes_types, PY3, error_from
...
def _get_hash_const(name):
    ...
    if name == "md4":
        from zdppy_jwt.passlib.crypto._md4 import md4
        return md4
...
if PY3 and _force_backend in ["any", "from-bytes"]:
    ...
    from struct import Struct
    from zdppy_jwt.passlib.utils import sys_bits
    ...
    from zdppy_jwt.passlib.utils import int_to_bytes
