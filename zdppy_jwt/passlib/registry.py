...
# pkg
from zdppy_jwt.passlib import exc
from zdppy_jwt.passlib.exc import ExpectedTypeError, PasslibWarning
from zdppy_jwt.passlib.ifc import PasswordHash
from zdppy_jwt.passlib.utils import (
    is_crypt_handler, has_crypt as os_crypt_present,
    unix_crypt_schemes as os_crypt_schemes,
)
from zdppy_jwt.passlib.utils.compat import unicode_or_str
from zdppy_jwt.passlib.utils.decor import memoize_single_value
# local
__all__ = [
...
_locations = dict(
    ...
    apr_md5_crypt = "zdppy_jwt.passlib.handlers.md5_crypt",
    argon2 = "zdppy_jwt.passlib.handlers.argon2",
    atlassian_pbkdf2_sha1 = "zdppy_jwt.passlib.handlers.pbkdf2",
    bcrypt = "zdppy_jwt.passlib.handlers.bcrypt",
    bcrypt_sha256 = "zdppy_jwt.passlib.handlers.bcrypt",
    bigcrypt = "zdppy_jwt.passlib.handlers.des_crypt",
    bsd_nthash = "zdppy_jwt.passlib.handlers.windows",
    bsdi_crypt = "zdppy_jwt.passlib.handlers.des_crypt",
    cisco_pix = "zdppy_jwt.passlib.handlers.cisco",
    cisco_asa = "zdppy_jwt.passlib.handlers.cisco",
    cisco_type7 = "zdppy_jwt.passlib.handlers.cisco",
    cta_pbkdf2_sha1 = "zdppy_jwt.passlib.handlers.pbkdf2",
    crypt16 = "zdppy_jwt.passlib.handlers.des_crypt",
    des_crypt = "zdppy_jwt.passlib.handlers.des_crypt",
    django_argon2 = "zdppy_jwt.passlib.handlers.django",
    django_bcrypt = "zdppy_jwt.passlib.handlers.django",
    django_bcrypt_sha256 = "zdppy_jwt.passlib.handlers.django",
    django_pbkdf2_sha256 = "zdppy_jwt.passlib.handlers.django",
    django_pbkdf2_sha1 = "zdppy_jwt.passlib.handlers.django",
    django_salted_sha1 = "zdppy_jwt.passlib.handlers.django",
    django_salted_md5 = "zdppy_jwt.passlib.handlers.django",
    django_des_crypt = "zdppy_jwt.passlib.handlers.django",
    django_disabled = "zdppy_jwt.passlib.handlers.django",
    dlitz_pbkdf2_sha1 = "zdppy_jwt.passlib.handlers.pbkdf2",
    fshp = "zdppy_jwt.passlib.handlers.fshp",
    grub_pbkdf2_sha512 = "zdppy_jwt.passlib.handlers.pbkdf2",
    hex_md4 = "zdppy_jwt.passlib.handlers.digests",
    hex_md5 = "zdppy_jwt.passlib.handlers.digests",
    hex_sha1 = "zdppy_jwt.passlib.handlers.digests",
    hex_sha256 = "zdppy_jwt.passlib.handlers.digests",
    hex_sha512 = "zdppy_jwt.passlib.handlers.digests",
    htdigest = "zdppy_jwt.passlib.handlers.digests",
    ldap_plaintext = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_md5 = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_sha1 = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_hex_md5 = "zdppy_jwt.passlib.handlers.roundup",
    ldap_hex_sha1 = "zdppy_jwt.passlib.handlers.roundup",
    ldap_salted_md5 = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_salted_sha1 = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_salted_sha256 = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_salted_sha512 = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_des_crypt = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_bsdi_crypt = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_md5_crypt = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_bcrypt = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_sha1_crypt = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_sha256_crypt = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_sha512_crypt = "zdppy_jwt.passlib.handlers.ldap_digests",
    ldap_pbkdf2_sha1 = "zdppy_jwt.passlib.handlers.pbkdf2",
    ldap_pbkdf2_sha256 = "zdppy_jwt.passlib.handlers.pbkdf2",
    ldap_pbkdf2_sha512 = "zdppy_jwt.passlib.handlers.pbkdf2",
    lmhash = "zdppy_jwt.passlib.handlers.windows",
    md5_crypt = "zdppy_jwt.passlib.handlers.md5_crypt",
    msdcc = "zdppy_jwt.passlib.handlers.windows",
    msdcc2 = "zdppy_jwt.passlib.handlers.windows",
    mssql2000 = "zdppy_jwt.passlib.handlers.mssql",
    mssql2005 = "zdppy_jwt.passlib.handlers.mssql",
    mysql323 = "zdppy_jwt.passlib.handlers.mysql",
    mysql41 = "zdppy_jwt.passlib.handlers.mysql",
    nthash = "zdppy_jwt.passlib.handlers.windows",
    oracle10 = "zdppy_jwt.passlib.handlers.oracle",
    oracle11 = "zdppy_jwt.passlib.handlers.oracle",
    pbkdf2_sha1 = "zdppy_jwt.passlib.handlers.pbkdf2",
    pbkdf2_sha256 = "zdppy_jwt.passlib.handlers.pbkdf2",
    pbkdf2_sha512 = "zdppy_jwt.passlib.handlers.pbkdf2",
    phpass = "zdppy_jwt.passlib.handlers.phpass",
    plaintext = "zdppy_jwt.passlib.handlers.misc",
    postgres_md5 = "zdppy_jwt.passlib.handlers.postgres",
    roundup_plaintext = "zdppy_jwt.passlib.handlers.roundup",
    scram = "zdppy_jwt.passlib.handlers.scram",
    scrypt = "zdppy_jwt.passlib.handlers.scrypt",
    sha1_crypt = "zdppy_jwt.passlib.handlers.sha1_crypt",
    sha256_crypt = "zdppy_jwt.passlib.handlers.sha2_crypt",
    sha512_crypt = "zdppy_jwt.passlib.handlers.sha2_crypt",
    sun_md5_crypt = "zdppy_jwt.passlib.handlers.sun_md5_crypt",
    unix_disabled = "zdppy_jwt.passlib.handlers.misc",
    unix_fallback = "zdppy_jwt.passlib.handlers.misc",
)
...
def register_crypt_handler_path(name, path):
    ...
    for a class named ``myhash`` within the ``myapp.helpers`` module::
        ...
        >>> from zdppy_jwt.passlib.registry import registry_crypt_handler_path
